    ...
    <div class="vs-hero-carousel" data-height="885" data-container="1900" data-slidertype="responsive">
        ...
        <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnsscale:1.2;">
            <img width="1920" height="888" src="landing/img/hero/hero-slide-4-1.jpg" class="ls-bg" alt="bg"
                decoding="async" />
            <img width="131" height="118" src="landing/img/hero/hero-shape-7.png" class="ls-l ls-img-layer" alt="shape"
                decoding="async"
...
<div class="space-top space-extra-bottom mt-5" data-bg-src="landing/img/bg/process-bg-1.jpg">
    <div class="container position-relative ">
        <div class="process-shape1 d-none d-lg-block"><img src="landing/img/icon/process-shape-1-1.png" alt="shape">
        </div>
            ...
            @for ($i = 1; $i < 9; $i++) <div class="col-sm-6 col-xl-4 col-xxl-3 wow fadeInUp" data-wow-delay="0.3s">
                <div class="gallery-style4">
                    ...
                    <div class="gallery-content">
                        ...
                        <a href="javascript:void(0)" class="gallery-btn"><img src="landing/img/icon/arrow-gal.png"
                                alt="icon"></a>
                    </div>
                </div>
        </div>
                ...
                <div class="vs-blog blog-style3">
                    <div class="blog-img">
                        <a href="{{ route('post.show', ['post' => $post->id]) }}"><img
                                src="{{ asset('landing/img/gallery/' . $loop->iteration . '.jpg') }}" alt="Blog Image"
                                class="w-100"></a>
                    </div>
