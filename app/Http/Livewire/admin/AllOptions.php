...
final class AllOptions extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('key_lower', fn (Option $model) => strtolower(e($model->key)))
    ...
    public function actions(): array
    {
       return [
           Button::make('edit', 'Edit')
               ...
               ->route('option.edit', function(\App\Models\Option $model) {
                    return $model->id;
               }),

           Button::make('destroy', 'Delete')
               ->class('bg-red-500 cursor-pointer text-white px-3 py-2 m-1 rounded text-sm')
               ->route('option.destroy', function(\App\Models\Option $model) {
                    return $model->id;
               })
               ->method('delete')
        ];
